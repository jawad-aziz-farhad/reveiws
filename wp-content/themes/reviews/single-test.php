            ...
            <div class="col-sm">              
                <?php for( $i = 1; $i < 4; $i++ ) { $index = $i == 1 ? '1st' : ($i == 2 ? '2nd' : '3rd'); ?>
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="5" id="<?php echo 'positive_'. $i ?>" placeholder="<?php echo 'Enter positive feedback '. $i ?>" disabled>
                      <?php 
            ...
            <div class="col-sm">
              <?php for( $i = 1; $i < 4; $i++ ) { $index = $i == 1 ? '1st' : ($i == 2 ? '2nd' : '3rd'); ?>
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="5" id="<?php echo 'negative_'. $i ?>" disabled><?php echo get_field($index .'_negative_feedback'); ?></textarea>
                </div>            
                <?php }; ?>     
            </div>
            <!-- .Negative -->
